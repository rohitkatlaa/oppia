...
describe('SvgFilenameEditor', function() {
  ...
  it('should undo and redo the creation of shapes', function() {
    ...
    expect(svgFilenameCtrl.canvas.getObjects().length).toBe(6);
    svgFilenameCtrl.canvas.setActiveObject(svgFilenameCtrl.canvas.getObjects()[5]);
  ...
  it('should change properties of a shape', function() {
    svgFilenameCtrl.createRect();
    svgFilenameCtrl.canvas.setActiveObject(svgFilenameCtrl.canvas.getObjects()[0]);
    ...
    svgFilenameCtrl.canvas.setActiveObject(svgFilenameCtrl.canvas.getObjects()[1]);
